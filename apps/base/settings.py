...
import bootstrap5.bootstrap as bootstrap
...
class _DefaultSettings:
    ...
    CRX_FRONTEND_NAVBAR_FORMAT_CHOICES = [
        ...
        ("navbar-center", "Centered logo at top"),
    ]
    ...
    CRX_FRONTEND_TEMPLATES_BLOCKS = {
        "cardblock": [
            ("base/blocks/card_block.html", "Card"),
            ("base/blocks/card_head.html", "Card with header"),
            ("base/blocks/card_foot.html", "Card with footer"),
            ("base/blocks/card_head_foot.html", "Card with header and footer"),
            (
                "base/blocks/card_blurb.html",
                "Blurb - rounded image and no border",
            ),
            (
                "base/blocks/card_img.html",
                "Cover image - use image as background",
            ),
        ],
        "cardgridblock": [
            (
                "base/blocks/cardgrid_group.html",
                "Card group - attached cards of equal size",
            ),
            (
                "base/blocks/cardgrid_deck.html",
                "Card deck - separate cards of equal size",
            ),
            (
                "base/blocks/cardgrid_columns.html",
                "Card masonry - fluid brick pattern",
            ),
        ],
        "pagelistblock": [
            ("base/blocks/pagelist_block.html", "General, simple list"),
            (
                "base/blocks/pagelist_list_group.html",
                "General, list group navigation panel",
            ),
            ("base/blocks/pagelist_article_media.html", "Article, media format"),
            (
                "base/blocks/pagelist_article_card_group.html",
                "Article, card group - attached cards of equal size",
            ),
            (
                "base/blocks/pagelist_article_card_deck.html",
                "Article, card deck - separate cards of equal size",
            ),
            (
                "base/blocks/pagelist_article_card_columns.html",
                "Article, card masonry - fluid brick pattern",
            ),
        ],
        "pagepreviewblock": [
            ("base/blocks/pagepreview_card.html", "Card"),
            ("base/blocks/pagepreview_form.html", "Form inputs"),
        ],
    ...
    CRX_FRONTEND_TEMPLATES_PAGES = {
        ...
        "*": [
            ("", "Default"),
            (
                "base/pages/web_page.html",
                "Web page showing title and cover image",
            ),
            (
                "base/pages/web_page_notitle.html",
                "Web page without title and cover image",
            ),
            (
                "base/pages/home_page.html",
                "Home page without title and cover image",
            ),
            ("base/pages/base.html", "Blank page - no navbar or footer"),
        ],
    }
