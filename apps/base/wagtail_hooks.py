...
def global_admin_css():
    return format_html(
        ...
        static("base/css/codered-admin.css"),
    )
...
def editor_css():
    return format_html(
        '<link rel="stylesheet" type="text/css" href="{}?v={}">',
        static("base/css/css-editor.css"),
    )
...
def register_icons(icons):
    ...
    icons.append("base/icons/cr-align-left.svg")
    icons.append("base/icons/cr-check-square-o.svg")
    icons.append("base/icons/cr-columns.svg")
    icons.append("base/icons/cr-desktop.svg")
    icons.append("base/icons/cr-font.svg")
    icons.append("base/icons/cr-google.svg")
    icons.append("base/icons/cr-hand-pointer-o.svg")
    icons.append("base/icons/cr-hashtag.svg")
    icons.append("base/icons/cr-header.svg")
    icons.append("base/icons/cr-list-alt.svg")
    icons.append("base/icons/cr-map.svg")
    icons.append("base/icons/cr-newspaper-o.svg")
    icons.append("base/icons/cr-puzzle-piece.svg")
    icons.append("base/icons/cr-recycle.svg")
    icons.append("base/icons/cr-stop.svg")
    icons.append("base/icons/cr-th-large.svg")
    icons.append("base/icons/cr-universal-access.svg")
    icons.append("base/icons/cr-usd.svg")
    icons.append("base/icons/cr-window-maximize.svg")
    icons.append("base/icons/cr-window-minimize.svg")
    return icons
...
def codered_forms(user, editable_forms):
    ...
    """
    from base.models import FormMixin
