...
class DownloadBlock(ButtonMixin, BaseBlock):
    ...
    advsettings_class = AdvTrackingSettings

    class Meta:
        template = "base/blocks/download_block.html"
        icon = "download"
        label = _("Download")
...
class EmbedGoogleMapBlock(BaseBlock):
    ...
    class Meta:
        template = "base/blocks/google_map.html"
        icon = "cr-map"
        label = _("Google Map")
...
class EmbedVideoBlock(BaseBlock):
    ...
    class Meta:
        template = "base/blocks/embed_video_block.html"
        icon = "media"
        label = _("Embed Media")
...
class H1Block(BaseBlock):
    ...
    class Meta:
        template = "base/blocks/h1_block.html"
        icon = "cr-header"
        label = _("Heading 1")
...
class H2Block(BaseBlock):
    ...
    class Meta:
        template = "base/blocks/h2_block.html"
        icon = "cr-header"
        label = _("Heading 2")
...
class H3Block(BaseBlock):
    ...
    class Meta:
        template = "base/blocks/h3_block.html"
        icon = "cr-header"
        label = _("Heading 3")
...
class ImageLinkBlock(BaseLinkBlock):
    ...
    class Meta:
        template = "base/blocks/image_link_block.html"
        icon = "image"
        label = _("Image Link")
        value_class = LinkStructValue
...
class PageListBlock(BaseBlock):
    ...
    class Meta:
        template = "base/blocks/pagelist_block.html"
        icon = "list-ul"
...
class PagePreviewBlock(BaseBlock):
    ...
    class Meta:
        template = "base/blocks/pagepreview_block.html"
