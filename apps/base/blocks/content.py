...
from .base import BaseBlock, BaseLayoutBlock, ButtonMixin, CollectionChooserBlock
from .html import ButtonBlock
...
class CardBlock(BaseBlock):
    ...
    class Meta:
        template = "base/blocks/card_foot.html"
        icon = "cr-list-alt"
        label = _("Card")
...
class CarouselBlock(BaseBlock):
    ...
    class Meta:
        icon = "image"
        label = _("Carousel")
        template = "base/blocks/carousel_block.html"
...
class ImageGalleryBlock(BaseBlock):
    ...
    class Meta:
        template = "base/blocks/image_gallery_block.html"
        icon = "image"
...
class ModalBlock(ButtonMixin, BaseLayoutBlock):
    ...
    class Meta:
        template = "base/blocks/modal_block.html"
...
class NavExternalLinkBlock(NavBaseLinkBlock):
    ...
    class Meta:
        template = "base/blocks/external_link_block.html"
...
class NavPageLinkBlock(NavBaseLinkBlock):
    ...
    class Meta:
        template = "base/blocks/page_link_block.html"
        label = _("Page Link")
...
class NavDocumentLinkBlock(NavBaseLinkBlock):
    ...
    class Meta:
        template = "base/blocks/document_link_block.html"
...
class PriceListItemBlock(BaseBlock):
    ...
    class Meta:
        template = "base/blocks/pricelistitem_block.html"
        icon = "cr-usd"
...
class PriceListBlock(BaseBlock):
    ...
    class Meta:
        template = "base/blocks/pricelist_block.html"
        icon = "cr-usd"
        label = _("Price List")
...
class ContentWallBlock(BaseBlock):
    ...
    class Meta:
        ...
        template = "base/blocks/content_wall_block.html"
...
class ReusableContentBlock(BaseBlock):
    ...
    class Meta:
        ...
        template = "base/blocks/reusable_content_block.html"
